...
export const SEED_NOTIFICATIONS: Notification[] = [
  {
    ...
    kind: 'grade',
    title: '需求分析报告已评分',
    body: '李教授给 Alpha 组打了 92 分，并附评语"需求分析全面、用例图清晰，建议补充非功能性需求的量化指标"',
    createdAt: ago(8),
  ...
  },
  {
    ...
    kind: 'grade',
    title: '系统设计文档已评分',
    body: '李教授给 Alpha 组打了 89 分，建议补充错误码规范',
    createdAt: ago(38),
    link: '/app/tasks/t-design',
    fromName: '李教授',
    fromColor: 'bg-brand-600',
  },
  {
    ...
    kind: 'task',
    title: '原型设计交付 已逾期',
    body: '截止时间已过 7 天，仅 1/3 组完成提交，你的 Alpha 组尚未提交',
    createdAt: ago(45),
  ...
  },
  {
    ...
    kind: 'announce',
    title: '李教授 发布课程公告',
    body: '中期答辩安排（本周三 14:00）：请各小组提前 15 分钟到达 J301',
    createdAt: ago(180),
  ...
  },
  {
    ...
    kind: 'doc',
    title: '王同学 @ 你',
    body: '在 系统设计文档 v1.0 评论里 @ 了你，问你部署视图章节的边界划分',
    createdAt: ago(220),
    link: '/app/docs/d-design-v1',
    fromName: '王同学',
  ...
  },
  {
    id: 'n-8',
    kind: 'task',
    title: '编码实现 Sprint 1 距截止 19 天',
    body: '你被指派为 Alpha 组本次 Sprint 的认证模块负责人',
    createdAt: ago(720),
    link: '/app/tasks/t-code',
    read: true,
  },
];
